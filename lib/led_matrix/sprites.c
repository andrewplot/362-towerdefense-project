...
const Color sprite_tree[5][3] = {{TREE_GREEN, TREE_GREEN, TREE_GREEN}, 
                         {TREE_GREEN, TREE_GREEN, TREE_GREEN}, 
                         {TREE_GREEN, TREE_GREEN, TREE_GREEN}, 
                         {GRASS     , TREE_BROWN, GRASS     }, 
                         {TREE_BROWN, TREE_BROWN, TREE_BROWN}};

const Color* const sprite_map[] = {
        [dart]  = (const Color*)  sprite_dart,
        [ninja]  = (const Color*) sprite_ninja,
        [bomb]  = (const Color*)  sprite_bomb,
        [sniper] = (const Color*) sprite_sniper,
        [blank] = (const Color*) sprite_blank,
};

Color* get_sprite_tree() {
    return sprite_tree;
}

Color* get_sprite(int type) {
